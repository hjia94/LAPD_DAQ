...
# ======================================================================================
DATA_FILE   = r"D:\data\LAPD\00-LP-p21p29p41-Xline-test_2026-05-19.hdf5"  # HDF5 file to analyze
...
XY_T_START_US   = 4000.0      # window start (us), used when XY_MODE == "range"
XY_T_END_US     = 4500.0      # window end   (us), used when XY_MODE == "range"
