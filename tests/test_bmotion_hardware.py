...
These tests call `run_acquisition_bmotion` against real motors and a real
bapsf_motion install. They are skipped by default; opt in by flipping the
...
# Safety gate — neither test will arm motors unless this is also True.
